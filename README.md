...
- `setHeight: function(opts){ ... },` | Function that sets `min-height` for the Google Maps `<iframe>` (callback).
...
- `triggerAsyncLoad: function(opts){ ... },` | Function to define when the maps should be loaded (callback).
